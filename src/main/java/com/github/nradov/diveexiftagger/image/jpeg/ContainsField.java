...
public abstract class ContainsField {
     ...
     */
    @Nonnull
    public abstract <T extends DataType> Optional<List<T>> getField(
            FieldTag tag, Class<T> clazz);
     ...
     */
    @Nonnull
    public Optional<List<SRational>> getFieldSRational(
            @Nonnull final FieldTag tag) {
     ...
     */
    @Nonnull
    public Optional<List<Undefined>> getFieldUndefined(
            @Nonnull final FieldTag tag) {
